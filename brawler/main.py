...
bg_image = pygame.image.load("brawler/assets/images/background/background.jpg").convert_alpha()

#! load spritesheets 
warrior_sheet = pygame.image.load("brawler/assets/images/warrior/Sprites/warrior.png").convert_alpha()
wizard_sheet = pygame.image.load("brawler/assets/images/wizard/Sprites/wizard.png")
